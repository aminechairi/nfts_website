      ...
      <div className="ctn">
        <div
          ...
          <div className="mr-12 hidden lg:block">
            <span style={{color: "var(--text-1)",}}>Get connected with us on social networks:</span>
          </div>
        ...
        <div 
          ...
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="">
              ...
              <p>
              Template For NFT, Token, And Web3 Marketplace Projects, Based On Tailwind CSS. Comes With All The Essential UI
              </p>
            </div>
            <div className="">
